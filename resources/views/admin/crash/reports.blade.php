...
@section('title', 'Crash Reports - Admin')

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold text-primary mb-0"><i class="bi bi-file-earmark-bar-graph me-2"></i>Crash Rocket Reports</h3>
        <a href="{{ route('admin.crash-admin.reports', ['range' => $range, 'export' => 'csv']) }}" class="btn btn-outline-primary fw-bold">
