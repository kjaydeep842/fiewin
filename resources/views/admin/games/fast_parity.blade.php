...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-0 text-dark">
            <i class="bi bi-lightning-charge-fill text-warning me-2"></i>Fast Parity (30s) Control Center
        </h4>
        <small class="text-secondary">Manage Fast Parity winning chances (RTP %), house edge, min/max limits & manual period overrides</small>
    </div>
    <form action="{{ route('admin.fast-parity.toggle') }}" method="POST">
        @csrf
...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm rounded-4 h-100">
            ...
            <div class="card-body">
                <form action="{{ route('admin.fast-parity.rtp') }}" method="POST">
                    @csrf
                    <div class="mb-3">
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm rounded-4 h-100">
            ...
            <div class="card-body">
                <form action="{{ route('admin.fast-parity.limits') }}" method="POST">
                    @csrf
...
<div class="card border-0 shadow-sm rounded-4 mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('admin.fast-parity.override') }}" method="POST">
            @csrf
...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-header bg-white border-0 fw-bold py-3">
        <i class="bi bi-clock-history me-2 text-primary"></i>Recent Fast Parity Settled Periods
    </div>
