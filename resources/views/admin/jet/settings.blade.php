...
@section('title', 'Jet Settings - Admin')

@section('content')
<div class="container-fluid py-4">
    <h3 class="fw-bold text-success mb-4"><i class="bi bi-gear me-2"></i>Jet Flight Game Settings</h3>
    ...
    <div class="card border-0 shadow-sm rounded-4 max-w-2xl">
        <div class="card-body p-4">
            <form action="{{ route('admin.jet.settings') }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-success btn-lg fw-bold w-100">SAVE SETTINGS</button>
            </form>
        </div>
    </div>
</div>
