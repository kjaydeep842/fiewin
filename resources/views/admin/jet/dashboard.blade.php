...
@section('title', 'Jet Flight Admin Control')
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-success fw-bold">
                <i class="bi bi-airplane-engines-fill me-2"></i>Jet Flight Control Center
            </h1>
            <p class="text-muted small mb-0">Independent Jet Game engine monitoring & manual control</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.jet.settings') }}" class="btn btn-outline-secondary">
                <i class="bi bi-gear me-1"></i>Settings
            </a>
            <a href="{{ route('admin.jet.reports') }}" class="btn btn-outline-primary">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3">
            <div class="card border-0 shadow-sm rounded-4 p-3 bg-white">
                <div class="text-muted small fw-bold">TODAY'S JET STAKES</div>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-header bg-white border-0 fw-bold py-3">
            <i class="bi bi-sliders me-2 text-success"></i>Next Jet Round Target Override
        </div>
        <div class="card-body">
            <form action="{{ route('admin.jet.override') }}" method="POST" class="row g-3 align-items-center">
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-md-3 d-flex align-items-end">
                    <button type="submit" class="btn btn-success btn-lg w-100 fw-bold">SET TARGET</button>
                </div>
            </form>
        </div>
    </div>
