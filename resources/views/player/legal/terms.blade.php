...
<div class="container-fluid p-0">
    ...
    <div class="alert alert-warning border-warning bg-warning bg-opacity-10 text-dark p-3 rounded-4 mb-3 d-flex align-items-center gap-3">
        ...
        <div class="small">
            <strong>18+ Age Restriction & Real Money Disclaimer:</strong> By registering and playing on Rivexa, you confirm that you are at least 18 years old and agree that real-money gaming involves financial risk. Play responsibly.
        </div>
    </div>
    ...
    <div class="gh-card p-4">
        ...
        <div class="mb-4">
            ...
            <p class="text-secondary small leading-relaxed">
                Participation in real-money games on Rivexa ("Platform") is strictly restricted to individuals who meet all of the following conditions:
            </p>
        ...
        <div class="mb-4">
            ...
            <p class="text-secondary small leading-relaxed mb-2">
                All financial transactions within the Rivexa platform are governed by the following strict rules:
            </p>
        ...
        <div class="mb-4">
            ...
            <p class="text-secondary small leading-relaxed mb-2">
                Rivexa maintains zero tolerance for unfair play or fraudulent activities. The following activities are strictly prohibited and will result in immediate account ban and forfeiture of funds:
            </p>
            <div class="row g-2">
                <div class="col-md-6">
        ...
        <div class="mb-4">
            ...
            <p class="text-secondary small leading-relaxed mb-0">
                Rivexa shall not be liable for losses caused by internet connectivity issues, device malfunctions, third-party payment delays, or user negligence. Platform outcomes generated by Provably Fair RNG engines are final and binding.
            </p>
        </div>
        ...
        <div>
            ...
            <p class="text-secondary small leading-relaxed mb-0">
                Rivexa reserves the right to modify these Terms & Conditions at any time. Continued use of the platform constitutes acceptance of updated terms. For legal inquiries, contact <a href="mailto:legal@fiewin.com" class="text-primary text-decoration-none fw-semibold">legal@fiewin.com</a>.
            </p>
        </div>
    </div>
</div>
