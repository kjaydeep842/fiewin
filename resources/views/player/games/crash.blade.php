    ...
    <div id="crashActiveBetCard" class="card border-0 shadow-sm rounded-4 mb-3 bg-primary-subtle border-start border-4 border-primary d-none">
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <span class="badge bg-primary px-2 py-1"><i class="bi bi-broadcast me-1"></i>ACTIVE ROCKET BET</span>
                <span class="text-muted small fw-bold">Period #<span id="crashActiveRoundId">-</span></span>
            </div>
            ...
            <div class="row g-2 mb-3">
                <div class="col-8">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="crashBetAmount" class="form-control form-control-lg bg-light border-0 fw-bold" value="100" min="10" max="50000">
                    </div>
                </div>
                <div class="col-4 d-flex align-items-end gap-1">
                    <button id="btnHalfBetCrash" class="btn btn-outline-secondary w-50 fw-bold">1/2</button>
                    <button id="btnDoubleBetCrash" class="btn btn-outline-secondary w-50 fw-bold">2X</button>
                </div>
            </div>
